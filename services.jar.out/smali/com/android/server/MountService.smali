...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    .line 1694
    const-string v2, "ro.mtk_multi_patition"
    ...
    invoke-direct {v0, v2, v3, v4, v5}, Lcom/android/server/MountService;->notifyVolumeChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    .line 1750
    .local v10, "devComp":Ljava/lang/String;
    const-string v2, ":"
    ...
    .line 1751
    .local v11, "devTok":[Ljava/lang/String;
    const/4 v2, 0x0
    ...
    .line 1759
    .end local v10    # "devComp":Ljava/lang/String;
    .end local v11    # "devTok":[Ljava/lang/String;
    :goto_4
    move-object/from16 v0, p0
    ...
    iget v2, v0, Lcom/android/server/MountService;->mUserId:I
    ...
    const-string v4, "Do not mount EXTERNAL_SD2 and EXTERNAL_OTG when user_id = "
    ...
    sget-object v2, Lcom/android/server/MountService;->EXTERNAL_OTG:Ljava/lang/String;
    ...
    const-string v3, "MountService#VolumeDiskInserted"

    move-object/from16 v0, p0

    move-object/from16 v1, v17

    invoke-direct {v2, v0, v3, v1}, Lcom/android/server/MountService$8;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2}, Lcom/android/server/MountService$8;->start()V
    ...
    const-string v3, "[SWAP] removed MTK_2SDCARD_SWAP"
    ...
    invoke-direct {v0, v1, v2, v14}, Lcom/android/server/MountService;->updatePublicVolumeState(Landroid/os/storage/StorageVolume;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v14, v1}, Lcom/android/server/MountService;->notifyVolumeChange(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1946
    .local v9, "defaultPath":Ljava/lang/String;
    invoke-direct/range {p0 .. p0}, Lcom/android/server/MountService;->updateDefaultpath()V
    ...
    .line 1951
    .end local v9    # "defaultPath":Ljava/lang/String;
    :cond_18
    const/16 v2, 0x2bc
    ...
    invoke-static {v2, v3}, Lcom/android/server/EventLogTags;->writeFstrimFinish(J)V
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/os/storage/StorageVolume;->toString()Ljava/lang/String;
    ...
    const-string v4, "VoldResponseCode.VolumeMountFailedBlank: send MEDIA_NOFS to volume :"
