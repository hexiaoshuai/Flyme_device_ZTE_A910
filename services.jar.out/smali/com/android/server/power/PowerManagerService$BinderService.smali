...
.method private shutdownOrRebootInternalForZTE(ZLjava/lang/String;Z)V
    .locals 4
    .param p1, "confirm"    # Z
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$6200(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/PowerManagerService$PowerManagerHandler;
    ...
    .line 3767
    :cond_1
    new-instance v1, Lcom/android/server/power/PowerManagerService$BinderService$1;

    invoke-direct {v1, p0, p1}, Lcom/android/server/power/PowerManagerService$BinderService$1;-><init>(Lcom/android/server/power/PowerManagerService$BinderService;Z)V
...
.method public boostScreenBrightness(J)V
    ...
    invoke-static {v3, p1, p2, v2}, Lcom/android/server/power/PowerManagerService;->access$7300(Lcom/android/server/power/PowerManagerService;JI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v2, p2}, Lcom/android/server/power/PowerManagerService;->access$7400(Lcom/android/server/power/PowerManagerService;Ljava/io/PrintWriter;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getScreenBrightnessMode()I
    ...
    const-string v4, "getScreenBrightnessMode is "
    ...
    invoke-static {v4}, Lcom/android/server/power/PowerManagerService;->access$6600(Lcom/android/server/power/PowerManagerService;)I
...
.method public setAttentionLight(ZI)V
    ...
    invoke-static {v2, p1, p2}, Lcom/android/server/power/PowerManagerService;->access$7200(Lcom/android/server/power/PowerManagerService;ZI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setBacklightOffForWfd(Z)V
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$7600(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/lights/Light;
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$7700(Lcom/android/server/power/PowerManagerService;)Z
...
.method public setBlNotify()V
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$7500(Z)V
...
.method public setScreenBrightnessAdjustment(I)I
    .locals 3
    ...
    .local v0, "ident":J
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/android/server/power/PowerManagerService$BinderService;->setScreenBrightnessAdjustmentInternal(I)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setScreenBrightnessAdjustmentInternal(I)I
    .locals 12
    .param p1, "adjustment"    # I
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mScreenBrightnessModeSetting:I
    invoke-static {v8}, Lcom/android/server/power/PowerManagerService;->access$6600(Lcom/android/server/power/PowerManagerService;)I
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentSetting:F
    invoke-static {v7}, Lcom/android/server/power/PowerManagerService;->access$6700(Lcom/android/server/power/PowerManagerService;)F
    ...
    const-string v9, "autosliderValue is "
    ...
    invoke-static {v7, v8}, Lcom/android/server/power/PowerManagerService;->access$6800(Lcom/android/server/power/PowerManagerService;F)V
    ...
    .line 3940
    .end local v0    # "autoSliderValue":I
    .end local v1    # "bret":I
    .local v2, "bret":I
    :goto_0
    return v2
    ...
    .line 3899
    .end local v2    # "bret":I
    .restart local v0    # "autoSliderValue":I
    ...
    .line 3908
    .local v6, "realAdjustment":F
    iget-object v7, p0, Lcom/android/server/power/PowerManagerService$BinderService;->this$0:Lcom/android/server/power/PowerManagerService;

    # invokes: Lcom/android/server/power/PowerManagerService;->setTemporaryScreenAutoBrightnessAdjustmentSettingOverrideInternal(F)V
    invoke-static {v7, v6}, Lcom/android/server/power/PowerManagerService;->access$6800(Lcom/android/server/power/PowerManagerService;F)V
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mContext:Landroid/content/Context;
    invoke-static {v7}, Lcom/android/server/power/PowerManagerService;->access$2400(Lcom/android/server/power/PowerManagerService;)Landroid/content/Context;
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mTemporaryScreenAutoBrightnessAdjustmentSettingOverride:F
    invoke-static {v9}, Lcom/android/server/power/PowerManagerService;->access$6900(Lcom/android/server/power/PowerManagerService;)F

    move-result v9

    const/4 v10, -0x2

    invoke-static {v7, v8, v9, v10}, Landroid/provider/Settings$System;->putFloatForUser(Landroid/content/ContentResolver;Ljava/lang/String;FI)Z

    .end local v0    # "autoSliderValue":I
    .end local v5    # "newSliderValue":F
    .end local v6    # "realAdjustment":F
    :goto_1
    move v2, v1
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mScreenBrightnessSetting:I
    invoke-static {v7}, Lcom/android/server/power/PowerManagerService;->access$7000(Lcom/android/server/power/PowerManagerService;)I

    move-result v3

    .line 3917
    .local v3, "manualSliderValue":I
    int-to-double v8, p1
    ...
    .line 3918
    .local v4, "newManualSliderValue":I
    const-string v7, "PowerManagerService"
    ...
    const-string v9, "manualSliderValue is "
    ...
    invoke-static {v7, v8}, Lcom/android/server/power/PowerManagerService;->access$6500(Lcom/android/server/power/PowerManagerService;I)V
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mTemporaryScreenBrightnessSettingOverride:I
    invoke-static {v9}, Lcom/android/server/power/PowerManagerService;->access$7100(Lcom/android/server/power/PowerManagerService;)I
...
.method public shutdownforZTE(ZZ)V
    .locals 3
    .param p1, "confirm"    # Z
    .param p2, "wait"    # Z
    ...
    :try_start_0
    invoke-direct {p0, p1, v2, p2}, Lcom/android/server/power/PowerManagerService$BinderService;->shutdownOrRebootInternalForZTE(ZLjava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
