...
.method private isCurrentIccInList(Ljava/util/List;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .local p1, "mccMncList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const/4 v2, 0x0
    ...
    const-string v4, "no Icc records"
    ...
    const-string v4, "current mccMnc = "
...
.method getCommandException(I)Lcom/android/internal/telephony/CommandException;
    ...
    invoke-static {v1}, Lcom/android/internal/telephony/MMTelSSUtils;->isEnableXcapHttpResponse409(I)Z
    ...
    const-string v2, "getCommandException UT_XCAP_409_CONFLICT"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/internal/telephony/MMTelSSUtils;->isOp05IccCard(I)Z
    ...
    const-string v18, "arResult is null."
    ...
    const-string v18, "[EVENT_SET_CALL_FORWARD_DONE check cfinfo."
    ...
    .line 1172
    .restart local v7    # "cfInfos":[Lcom/android/internal/telephony/CallForwardInfo;
    iget-object v0, v4, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    sget-object v19, Lcom/android/internal/telephony/CommandException$Error;->UT_XCAP_404_NOT_FOUND:Lcom/android/internal/telephony/CommandException$Error;
...
.method public isFeatureSupported(Lcom/android/internal/telephony/Phone$FeatureType;)Z
    ...
    .line 1675
    .local v1, "featureSupportedMccMncList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const/4 v0, 0x0
    ...
    .line 1681
    const-string v0, "VOLTE_ENHANCED_CONFERENCE"
    ...
    const-string v5, "isFeatureSupported: unknown feature: "
    ...
    .line 1690
    :cond_2
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isCurrentIccInList(Ljava/util/List;)Z
