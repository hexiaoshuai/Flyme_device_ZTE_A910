...
# hxs modify begin
	Landroid/view/ViewRootImpl$ItemRecod;,
# hxs modify end
...
# hxs modify begin
.field private static final MSG_DISPATCH_WINDOW_SCREEN_SHOT:I = 0x1b
# hxs modify end
...
.method static constructor <clinit>()V
    ...
    .line 192
    const-string v0, "ro.mtk_perf_response_time"
...
# hxs modify begin
    ...
    iput-object v0, p0, Landroid/view/ViewRootImpl;->recordSp:Landroid/util/SparseArray;

    iput v2, p0, Landroid/view/ViewRootImpl;->mCurrentfirstVisibleItem:I

    iput v2, p0, Landroid/view/ViewRootImpl;->flag:I

    iput v2, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    iput-object v1, p0, Landroid/view/ViewRootImpl;->find:Landroid/view/View;

    iput v2, p0, Landroid/view/ViewRootImpl;->lastTime:I
# hxs modify begin
...
.method static synthetic access$3102(Landroid/view/ViewRootImpl;Landroid/view/KeyEvent;)Landroid/view/KeyEvent;
    .locals 0
    .param p0, "x0"    # Landroid/view/ViewRootImpl;
    .param p1, "x1"    # Landroid/view/KeyEvent;
...
.method static synthetic access$3202(Landroid/view/ViewRootImpl;J)J
    .locals 1
    .param p0, "x0"    # Landroid/view/ViewRootImpl;
    .param p1, "x1"    # J
...
.method static synthetic access$3302(Landroid/view/ViewRootImpl;Landroid/view/MotionEvent;)Landroid/view/MotionEvent;
    .locals 0
    .param p0, "x0"    # Landroid/view/ViewRootImpl;
...
.method static synthetic access$4000(Landroid/view/ViewRootImpl;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    .locals 1
    .param p0, "x0"    # Landroid/view/ViewRootImpl;
...
# hxs modify begin
    ...
    iget v3, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    if-ne v3, v9, :cond_hxs_0

    iput v8, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    invoke-direct {p0, p1, p2, p3}, Landroid/view/ViewRootImpl;->obtainQueuedInputEvent(Landroid/view/InputEvent;Landroid/view/InputEventReceiver;I)Landroid/view/ViewRootImpl$QueuedInputEvent;

    move-result-object v10

    .local v10, "q":Landroid/view/ViewRootImpl$QueuedInputEvent;
    invoke-direct {p0, v10}, Landroid/view/ViewRootImpl;->finishInputEvent(Landroid/view/ViewRootImpl$QueuedInputEvent;)V

    iput-object v8, p0, Landroid/view/ViewRootImpl;->find:Landroid/view/View;
    ...
    const-string v5, "screen mode change finishInputEvent"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string/jumbo v5, " InputEvent="
    ...
    iget v6, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    invoke-interface {v4, v5, v6}, Landroid/view/IWindowSession;->screenShotModeOver(Landroid/os/IBinder;I)V
    :try_end_hxs_0
    ...
    .end local v10    # "q":Landroid/view/ViewRootImpl$QueuedInputEvent;
    :cond_hxs_0
    iget v3, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    if-le v3, v9, :cond_hxs_1

    iget v3, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    add-int/lit8 v3, v3, -0x1

    iput v3, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I
...
# hxs modify begin
    .end local v10    # "last":Landroid/view/ViewRootImpl$QueuedInputEvent;
    :catch_hxs_0
    move-exception v1
...
.method scheduleTraversals()V
    ...
    .line 1243
    const-string v1, "scheduleTraversals by message"
    ...
    .line 1251
    .restart local v0    # "scheduleByHandler":Z
    :cond_5
    const-string v1, "ViewRootImpl"
...
# hxs modify begin
.method public dispatchScreenShot(I)V
    .locals 4
    .param p1, "amount"    # I
    ...
    const-string/jumbo v3, "viewRoot dispatchScreenShot amount="
...
.method static synthetic getMScreenShotMode(Landroid/view/ViewRootImpl;)I
    .locals 1

    iget v0, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    return v0
.end method

.method static synthetic setMScreenShotMode(Landroid/view/ViewRootImpl;I)I
    .locals 0

    iput p1, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    return p1
.end method

.method static synthetic setMCurrentfirstVisibleItem(Landroid/view/ViewRootImpl;I)I
    .locals 0

    iput p1, p0, Landroid/view/ViewRootImpl;->mCurrentfirstVisibleItem:I

    return p1
.end method

.method static synthetic getRecordSp(Landroid/view/ViewRootImpl;)Landroid/util/SparseArray;
    .locals 1

    iget-object v0, p0, Landroid/view/ViewRootImpl;->recordSp:Landroid/util/SparseArray;

    return-object v0
.end method

.method public findListOrScroll(Landroid/view/View;)Landroid/view/View;
    .locals 7
    ...
    invoke-virtual {p0, v3}, Landroid/view/ViewRootImpl;->findListOrScroll(Landroid/view/View;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, Landroid/view/ViewRootImpl;->isViewCovered(Landroid/view/View;)Z

    move-result v4

    if-nez v4, :cond_2

    const-string/jumbo v4, "guojingdong"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "findListOrScroll temp="
...
.method findViewForScroll(Landroid/view/View;I)V
    .locals 18
    .param p1, "view"    # Landroid/view/View;
    .param p2, "step"    # I
    ...
    iget-object v1, v0, Landroid/view/ViewRootImpl;->find:Landroid/view/View;
    ...
    iget-object v3, v0, Landroid/view/ViewRootImpl;->find:Landroid/view/View;
    ...
    iget v1, v0, Landroid/view/ViewRootImpl;->flag:I
    ...
    iput v1, v0, Landroid/view/ViewRootImpl;->flag:I
    ...
    invoke-virtual {v0, v1}, Landroid/view/ViewRootImpl;->setListOnScrollListener(Landroid/widget/ListView;)V
    ...
    invoke-virtual {v0, v1}, Landroid/view/ViewRootImpl;->isListViewScrollOver(Landroid/widget/ListView;)Z
    ...
    invoke-direct/range {p0 .. p0}, Landroid/view/ViewRootImpl;->getScrollY()I
    ...
    iput v1, v0, Landroid/view/ViewRootImpl;->mCurrentfirstVisibleItem:I

    move-object/from16 v0, p0

    iget-object v1, v0, Landroid/view/ViewRootImpl;->recordSp:Landroid/util/SparseArray;
    ...
    iput v1, v0, Landroid/view/ViewRootImpl;->mScreenShotMode:I

    const/4 v1, 0x0

    move-object/from16 v0, p0

    iput-object v1, v0, Landroid/view/ViewRootImpl;->find:Landroid/view/View;

    const-string/jumbo v1, "guojingdong"

    const-string/jumbo v2, "listview mWindowSession.scrollWindowOver(mWindow,2)"
    ...
    :try_start_1
    invoke-virtual/range {p0 .. p0}, Landroid/view/ViewRootImpl;->scrollWindow()V
    ...
    const-string/jumbo v2, "listview mWindowSession.scrollWindowOver(mWindow,1)"
    ...
    invoke-virtual {v0, v1}, Landroid/view/ViewRootImpl;->isScrollViewScrollOver(Landroid/widget/ScrollView;)Z
    ...
    .line 1221
    const-string/jumbo v2, "scrollview mWindowSession.scrollWindowOver(mWindow,2)"
    ...
    .line 1237
    const-string/jumbo v2, "scrollview mWindowSession.scrollWindowOver(mWindow,1)"
    ...
    iget-object v8, v0, Landroid/view/ViewRootImpl;->mWindowSession:Landroid/view/IWindowSession;

    move-object/from16 v0, p0

    iget-object v9, v0, Landroid/view/ViewRootImpl;->mWindow:Landroid/view/ViewRootImpl$W;
    ...
    invoke-interface/range {v8 .. v15}, Landroid/view/IWindowSession;->scrollWindowOver(Landroid/os/IBinder;IIIIII)V

    const-string/jumbo v1, "guojingdong"

    const-string/jumbo v2, "auto scroll window 4"
...
.method public isViewCovered(Landroid/view/View;)Z
    .locals 10
    .param p1, "view"    # Landroid/view/View;
    ...
    :cond_0
    invoke-direct {p0, v1, v0}, Landroid/view/ViewRootImpl;->indexOfViewInParent(Landroid/view/View;Landroid/view/ViewGroup;)I
    ...
    .local v4, "otherViewRect":Landroid/graphics/Rect;
    ...
    .end local v4    # "otherViewRect":Landroid/graphics/Rect;
...
.method private getScrollY()I
    ...
    .local v1, "i":I
    :goto_0
    iget v3, p0, Landroid/view/ViewRootImpl;->mCurrentfirstVisibleItem:I

    if-ge v1, v3, :cond_0

    iget-object v3, p0, Landroid/view/ViewRootImpl;->recordSp:Landroid/util/SparseArray;

    invoke-virtual {v3, v1}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/view/ViewRootImpl$ItemRecod;

    .local v2, "itemRecod":Landroid/view/ViewRootImpl$ItemRecod;
    iget v3, v2, Landroid/view/ViewRootImpl$ItemRecod;->height:I
    ...
    .end local v2    # "itemRecod":Landroid/view/ViewRootImpl$ItemRecod;
    :cond_0
    iget-object v3, p0, Landroid/view/ViewRootImpl;->recordSp:Landroid/util/SparseArray;

    iget v4, p0, Landroid/view/ViewRootImpl;->mCurrentfirstVisibleItem:I
    ...
    .restart local v2    # "itemRecod":Landroid/view/ViewRootImpl$ItemRecod;
    if-nez v2, :cond_1

    new-instance v2, Landroid/view/ViewRootImpl$ItemRecod;

    .end local v2    # "itemRecod":Landroid/view/ViewRootImpl$ItemRecod;
    invoke-direct {v2, p0}, Landroid/view/ViewRootImpl$ItemRecod;-><init>(Landroid/view/ViewRootImpl;)V

    .restart local v2    # "itemRecod":Landroid/view/ViewRootImpl$ItemRecod;
    :cond_1
    iget v3, v2, Landroid/view/ViewRootImpl$ItemRecod;->top:I
...
.method public scrollWindow()V
    .locals 1

    .prologue
    new-instance v0, Landroid/view/ViewRootImpl$ScrollWindow;

    invoke-direct {v0, p0}, Landroid/view/ViewRootImpl$ScrollWindow;-><init>(Landroid/view/ViewRootImpl;)V

    invoke-virtual {v0}, Landroid/view/ViewRootImpl$ScrollWindow;->start()V

    return-void
.end method

.method public obtainMotionDownEvent(JJIFF)V
    .locals 13
    ...
    .prologue
    iget v2, p0, Landroid/view/ViewRootImpl;->mScreenShotMode:I
    ...
    invoke-virtual {v11, v2}, Landroid/view/MotionEvent;->setSource(I)V
    ...
    invoke-virtual {p0, v11}, Landroid/view/ViewRootImpl;->dispatchInputEvent(Landroid/view/InputEvent;)V
    ...
    const-string/jumbo v2, "guojingdong"
...
.method public obtainMotionMoveEvent(JJIFF)V
    .locals 13
    .param p1, "eventTime"    # J
    .param p3, "downTime"    # J
    .param p5, "time"    # I
...
.method public obtainMotionUpEvent(JJIFF)V
    .locals 13
    .param p1, "eventTime"    # J
    .param p3, "downTime"    # J
    .param p5, "time"    # I
...
.method setListOnScrollListener(Landroid/widget/ListView;)V
    .locals 1
    .param p1, "listview"    # Landroid/widget/ListView;

    .prologue
    new-instance v0, Landroid/view/ViewRootImpl$SetListOnScrollListener;

    invoke-direct {v0, p0}, Landroid/view/ViewRootImpl$SetListOnScrollListener;-><init>(Landroid/view/ViewRootImpl;)V
